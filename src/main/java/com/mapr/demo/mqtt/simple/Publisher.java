...
public class Publisher {
  ...
  public static void main(String[] args) {
    ...
    private static boolean sendToRobot (String move, int robot_id){
        String topic = "Saqr/walk/" + Integer.toString(robot_id);
...
//        MemoryPersistence persistence = new MemoryPersistence();
        try {
            ...
            subscriber_client.subscribe("Saqr/Ack/" + Integer.toString(robot_id));
            ...
            while (SimpleMqttCallBack.acknowledge == false) ;
